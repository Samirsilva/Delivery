...
import com.delivery.domain.Item;
...
public class RepositoryTest implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		Cliente fernando = new Cliente(ID_CLIENTE_FERNANDO, "Fernando Souza", "São Paulo");
		Cliente zePequeno = new Cliente(ID_CLIENTE_ZE_PEQUENO, "Zé Pequeno", "Cidade de Deus");

		Item dog1 = new Item(ID_ITEM1, "Cachorro quente tradicional", 25d);
		Item dog2 = new Item(ID_ITEM2, "Cachorro quente mega", 27d);
		Item dog3 = new Item(ID_ITEM3, "Cachorro quente max" , 30d);
